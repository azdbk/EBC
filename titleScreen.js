...
let resources = {
  images: [
    {id: "background", src: "assets/introImages/introImage.png" },
    {id: "logo", src: "assets/introImages/logoTitle.png" },
    {id: "intro", src: "assets/introImages/text.png" },
    {id: "credit", src: "assets/introImages/credit.png" },
    {id: "playButton", src: "assets/introImages/play.png" },
    {id: "creditsInfo", src: "assets/introImages/creditInfoPage.png" },
    {id: "backButton", src: "assets/introImages/back.png" } // Add back button image
  ],       
  audios:[ 
